...
const Header = () => (
    ...
    <Nav pullRight className={'social-nav'}>
      <li><a href={'https://www.facebook.com/SaadKhtk/'} target={'_blank'}><img src={'../images/fb-header.png'} /></a></li>
      <li><a href={'https://twitter.com/SaadKhtk'} target={'_blank'}><img src={'../images/twitter-header.png'} /></a></li>
    </Nav>
    <Navbar.Collapse>
  ...
  <section className={'footer'} style={{'background-color':'#2d2d2d', }}>
      ...
      <Grid className={'copy-right'}>
          ...
          <div className={'social'}>
              <a href={'https://www.facebook.com/SaadKhtk/'} target={'_blank'}><img src={'../images/fb-footer.png'} style={{'height':'22px', 'padding-right':'15px', 'padding-bottom':'2px', }} /></a>
              <a href={'https://twitter.com/SaadKhtk'} target={'_blank'}><img src={'../images/twitter-footer.png'} style={{'height':'20px', 'padding-right':'15px',}} /></a>
          </div>
      </Grid>
  </section>
)
...
const TemplateWrapper = ({ children }) => (
  <div>
    <Helmet title="Saad Khattak" meta={[{ name: 'description', content: 'Sample' }, { name: 'keywords', content: 'sample, something' }, ]}>
